      ...
      <div class="col-md-6 col-md-offset-3 ">
       ...
       <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  @submit.prevent="uploadGuideSubmit">
              <div class="box-body">
                <div class="form-group">
                  <label for="study_guide" >Study Guide</label>
                  <input type="file" id="study_guide" name="study_guide" v-validate="{ mimes: ['application/vnd.ms-excel'] }"  v-on:change="onFileSelected"  >
                  <small v-if="errors.has('study_guide')" class="help is-danger">{{ errors.first('study_guide') }}</small>
     ...
     uploadGuideSubmit() {
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          fd.append('study_guide',this.form.selectedFile );
          services
            .uploadGuide(fd)
            .then(response => {
